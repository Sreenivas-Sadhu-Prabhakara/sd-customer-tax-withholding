package com.bank.bian.customertaxwithholding.model;
...
/**
 * The BIAN control record for this service domain: "Tax Withholding Record Procedure".
 *
 ...
 * to its asset type (Tax Withholding Record). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Tax Withholding Record Procedure";
